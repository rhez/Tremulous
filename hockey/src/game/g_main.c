...
#define QVM_NAME       "HockeyQVM"
#define QVM_VERSIONNUM      "RF-MULTIPROTOCOL-1.1"
...
static cvarTable_t   gameCvarTable[ ] =
{
  ...
  { &g_spawnPuck, "g_spawnPuck", "1", CVAR_ARCHIVE, 0, qfalse },
  { &g_puckName, "g_puckName", "Puck", CVAR_ARCHIVE, 0, qfalse },
...
void G_RunFrame( int levelTime )
{
  ...
  if(!level.puckIsSpawned && g_spawnPuck.integer > 0)
  {
    G_BotAdd( g_puckName.string, PTE_ALIENS, 1 );
    level.puckIsSpawned = qtrue;
  }
